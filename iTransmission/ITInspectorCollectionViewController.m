...
- (void)loadView
{
    ...
    SVSegmentedControl *segmentedControl = [[SVSegmentedControl alloc] initWithSectionTitles:[NSArray arrayWithObjects:@"Info", @"Trackers", @"Files", @"Peers", nil]];
    ...
    ITTrackersInspectorViewController *trackersInspector = [[ITTrackersInspectorViewController alloc] initWithTorrent:self.torrent];
    ...
    self.childViewControllers = [NSArray arrayWithObjects:infoInspector, trackersInspector, filesInspector, peersInspector, nil];
