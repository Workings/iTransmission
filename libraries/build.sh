...
function do_transmission {	
	...
	./configure --prefix="${BUILD_DIR}" ${COMMON_OPTIONS} --enable-largefile --disable-nls --enable-lightweight --disable-mac --disable-gtk --with-kqueue --disable-debug
